...
철도 주행 영상에서 전차선로 주변 지장수목 의심 프레임을 샘플링하고, GPT vision VQA로 위험 후보를 판정해 캡처와 현장 양식형 PDF 리포트를 생성하는 데스크톱 프로그램입니다.
...
- 결과: 구간별 고유 탐지 프레임을 세로로 정리한 PDF, 저장 직후 인앱 미리보기,
  캡처 이미지, HTML/Markdown 리포트, JSON 산출물
